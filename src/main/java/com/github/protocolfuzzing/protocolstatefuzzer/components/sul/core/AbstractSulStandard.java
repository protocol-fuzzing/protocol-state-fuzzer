 ...
 */
public abstract class AbstractSulStandard implements AbstractSul<AbstractInput, AbstractOutput> {
     ...
     *
     */
    public AbstractSulStandard(SulConfig sulConfig, CleanupTasks cleanupTasks) {
