...
public class ObservationTree<I, O> {
    protected final ObservationTree<I, O> parent;
    protected final I parentInput;
    protected final O parentOutput;
    protected final Map<I, ObservationTree<I, O>> children;
    protected final Map<I, O> outputs;

    public ObservationTree() {
        this(null, null, null);
    }

    protected ObservationTree(ObservationTree<I, O> parent, I parentInput, O parentOutput) {
     ...
     * @throws CacheInconsistencyException on inconsistent with previous observations input
     */
    ...
    public void addObservation(List<I> inputs, List<O> outputs) throws CacheInconsistencyException {
        ...
        try {
            this.addObservation(firstInput, firstOutput).addObservation(inputs.subList(1, inputs.size()),
