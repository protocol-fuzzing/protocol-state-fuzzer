...
public class DFAUtils extends AutomatonUtils {
	...
	protected static <MI, MS, MO, DI, DS, DA extends MutableDFA<DS, DI>>  void convertMealyToDFA(MS mealyState, DS dfaState, MealyMachine<MS, MI, ?, MO> mealy,
	...
	public static <S,I> Word<I> findShortestAcceptingWord( DFA<S, I> automaton, Collection<I> inputs ) {
		DeterministicEquivalenceTest<I> test = new DeterministicEquivalenceTest<>(DFAs.complete(automaton, new ListAlphabet<>(new ArrayList<>(inputs))));
