    ...
    public void invalidParseWithEmpty_SFCstd_SULCstd_SFSstd_SULSemp() {
        invalidParseWithEmpty(
            new StateFuzzerConfigBuilder() {
                ...
                @Override
                public StateFuzzerServerConfig buildServerConfig() {
                    return new StateFuzzerServerConfigStandard(null, new SulServerConfigEmpty(new MapperConfig(){}, null), null, null);
                }
            },
            SUL_CLIENT_CONFIG_STANDARD_REQ_ARGS,
            null
    ...
    public void invalidParseWithEmpty_SFCstd_SULCstd_SFSemp_SULSstd() {
        invalidParseWithEmpty(
            new StateFuzzerConfigBuilder() {
                ...
                @Override
                public StateFuzzerServerConfig buildServerConfig() {
                    return new StateFuzzerServerConfigEmpty(null, new SulServerConfigStandard(new MapperConfig(){}, null), null, null);
                }
            },
            SUL_CLIENT_CONFIG_STANDARD_REQ_ARGS,
            SUL_SERVER_CONFIG_STANDARD_REQ_ARGS
    ...
    public void invalidParseWithEmpty_SFCstd_SULCemp_SFSstd_SULSstd() {
        invalidParseWithEmpty(
            new StateFuzzerConfigBuilder() {
                @Override
                public StateFuzzerClientConfig buildClientConfig() {
                    return new StateFuzzerClientConfigStandard(null, new SulClientConfigEmpty(new MapperConfig(){}, null), null, null);
                }
                @Override
                public StateFuzzerServerConfig buildServerConfig() {
                    return new StateFuzzerServerConfigStandard(null, new SulServerConfigStandard(new MapperConfig(){}, null), null, null);
    ...
    public void invalidParseWithEmpty_SFCemp_SULCstd_SFSstd_SULSstd() {
        invalidParseWithEmpty(
            new StateFuzzerConfigBuilder() {
                @Override
                public StateFuzzerClientConfig buildClientConfig() {
                    return new StateFuzzerClientConfigEmpty(null, new SulClientConfigStandard(new MapperConfig(){}, null), null, null);
                }
                @Override
                public StateFuzzerServerConfig buildServerConfig() {
                    return new StateFuzzerServerConfigStandard(null, new SulServerConfigStandard(new MapperConfig(){}, null), null, null);
    ...
    public void invalidParseWithEmpty_SFCstd_SULCstd_SFSemp_SULSemp() {
        invalidParseWithEmpty(
            new StateFuzzerConfigBuilder() {
                ...
                @Override
                public StateFuzzerServerConfig buildServerConfig() {
                    return new StateFuzzerServerConfigEmpty(null, new SulServerConfigEmpty(new MapperConfig(){}, null), null, null);
                }
            },
            SUL_CLIENT_CONFIG_STANDARD_REQ_ARGS,
            null
    ...
    public void invalidParseWithEmpty_SFCemp_SULCemp_SFSstd_SULSstd() {
        invalidParseWithEmpty(
            new StateFuzzerConfigBuilder() {
                @Override
                public StateFuzzerClientConfig buildClientConfig() {
                    return new StateFuzzerClientConfigEmpty(null, new SulClientConfigEmpty(new MapperConfig(){}, null), null, null);
                }
                @Override
                public StateFuzzerServerConfig buildServerConfig() {
                    return new StateFuzzerServerConfigStandard(null, new SulServerConfigStandard(new MapperConfig(){}, null), null, null);
